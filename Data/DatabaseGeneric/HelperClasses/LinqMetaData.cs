...
namespace WorkerServicesDemo.Data.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((WorkerServicesDemo.Data.EntityType)typeOfEntity)
			{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting DemoEntity instances in the database.</summary>
		public DataSource2<DemoEntity> Demo {	get { return new DataSource2<DemoEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
