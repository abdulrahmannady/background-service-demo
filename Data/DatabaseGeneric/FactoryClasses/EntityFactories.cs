...
namespace WorkerServicesDemo.Data.FactoryClasses
{
	...
	{
		private readonly WorkerServicesDemo.Data.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, WorkerServicesDemo.Data.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((WorkerServicesDemo.Data.EntityType)entityTypeValue); }
	...
	/// <summary>Factory to create new, empty DemoEntity objects.</summary>
	[Serializable]
	public partial class DemoEntityFactory : EntityFactoryBase2<DemoEntity> 
	{
		/// <summary>CTor</summary>
		public DemoEntityFactory() : base("DemoEntity", WorkerServicesDemo.Data.EntityType.DemoEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new DemoEntity(fields); }
	}
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(WorkerServicesDemo.Data.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(WorkerServicesDemo.Data.EntityType)))
			{
				var factory = GetFactory((WorkerServicesDemo.Data.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the WorkerServicesDemo.Data.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(WorkerServicesDemo.Data.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case WorkerServicesDemo.Data.EntityType.DemoEntity:
					return new DemoEntityFactory();
				default:
					return null;
			}
		}
	...
	{
		/// <summary>Gets the factory of the Entity type with the WorkerServicesDemo.Data.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (WorkerServicesDemo.Data.EntityType)Enum.Parse(typeof(WorkerServicesDemo.Data.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((WorkerServicesDemo.Data.EntityType)Enum.Parse(typeof(WorkerServicesDemo.Data.EntityType), leftOperandEntityName, false), joinType, (WorkerServicesDemo.Data.EntityType)Enum.Parse(typeof(WorkerServicesDemo.Data.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (WorkerServicesDemo.Data.EntityType)Enum.Parse(typeof(WorkerServicesDemo.Data.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((WorkerServicesDemo.Data.EntityType)entityTypeValue); }
